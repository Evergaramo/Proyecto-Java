...
BigInteger id_user=Autenticacion.getId_user();
  ...
  <body>
    <div align="center">
    	...
    	<script>
			...
			//insertar
			var id_usuario=<%out.print(id_user);%>;
			var fecha = new Date();
			function insertar(){
				...
				con.connect(function(err) {
				  if (err) throw err;
				  var sql = "INSERT INTO partidas (usuario, fecha, puntos, tiempo) VALUES ('"+id_usuario+"', '"+fecha+"', '"+puntos+"', '"+timeout+"')";
